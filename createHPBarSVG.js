export function createHPBarSVG(hp, maxhp, tempHP){
  ...
  let thpp = Number(tempHP / maxhp)
  let tempHPBarWidth = (hpBarWidth * thpp).toFixed(0);
  ...
  if(hpp > 0.4){
    svgStr += `<rect width="${curHPBarWidth}" height="${hpBarHeight}" x="10" y="0" rx="10" ry="10" fill="url(#grad1)" />`
  }else if(hpp > 0.15){
    svgStr += `<rect width="${curHPBarWidth}" height="${hpBarHeight}" x="10" y="0" rx="10" ry="10" fill="url(#grad2)" />`
  }else{
    svgStr += `<rect width="${curHPBarWidth}" height="${hpBarHeight}" x="10" y="0" rx="10" ry="10" fill="url(#grad3)" />`
  }
  svgStr += `<rect width="${tempHPBarWidth}" height="${hpBarHeight/2}" x="10" y="0" rx="5" ry="5" fill="url(#grad4)" />`
